...
Revision ID: c27f5d1dfaaf
Revises: 
Create Date: 2024-02-24 14:40:04.005304
...
revision: str = '53a9fcde6d41'
down_revision: Union[str, None] = None
branch_labels: Union[str, Sequence[str], None] = None
depends_on: Union[str, Sequence[str], None] = None

filename = os.path.join(os.path.dirname(__file__), "../data/students.json")
